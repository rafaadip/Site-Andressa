...
| E2E do painel e de UX falhando sob `--repeat-each` | Bloqueio do dia INTEIRO pegava consultas de outros testes (e exigia decisão para elas); a reserva "da outra pessoa" pelo 1º horário livre divergia do que a página mostrava; o fluxo pela UI não tratava o 409 | Bloqueio só do intervalo da própria consulta; a outra pessoa reserva exatamente o horário da página (201 ou 409 = tomado); o fluxo pela UI escolhe outro horário no 409, como o paciente. Todos os specs que agendam, `--workers=2 --repeat-each=3`: 189/189, duas vezes |
